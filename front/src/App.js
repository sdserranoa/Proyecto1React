    ...
    <div id="content">
      <Router>
        <NavigationBar />
          ...
          <Route path="/projects/create" exact component={ProjectCreate} />{/*TODO */}
          <Route path="/projects/edit" exact component={ProjectEdit} />{/*TODO */}
          <Route path="/projects/detail/:id" exact component={ProjectDetails} />{/*TODO */}
